...
export const tables = {
  ...
  /** News and events, each of which gets its own public page. */
  events: env('APPWRITE_EVENTS_TABLE_ID', 'events'),
  /** Age-group training programmes, each of which gets its own public page. */
  programs: env('APPWRITE_PROGRAMS_TABLE_ID', 'programs'),
};
